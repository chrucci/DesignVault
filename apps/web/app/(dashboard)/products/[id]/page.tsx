      ...
      <div className="max-w-2xl space-y-6">
        ...
        <ProductForm
          initialData={{
            ...
            color: product.color || "",
            stock_status: (product.stock_status as "in_stock" | "out_of_stock" | "special_order" | "unknown") || "unknown",
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-4">
          ...
          {(product.dimensions_width || product.dimensions_depth || product.dimensions_height || product.dimensions_text) && (
            <div>
          ...
          {product.source_url && (
            <div>
              ...
              <p>
                <a href={product.source_url} target="_blank" rel="noopener noreferrer" className="text-primary underline">
                  {product.source_url}
                </a>
              </p>
            </div>
          ...
          {product.spec_url && (
            <div>
              ...
              <p>
                <a href={product.spec_url} target="_blank" rel="noopener noreferrer" className="text-primary underline">
                  {product.spec_url}
                </a>
              </p>
            </div>
